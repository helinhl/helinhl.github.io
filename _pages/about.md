...
- [07/2024] Luori and 6Vision accepted to [ICNP'24](https://icnp24.cs.ucr.edu/). Congrats to Daguo and Wenjian!
- [06/2024] Invited to serve as the AEC for [SIGCOMM'24](https://conferences.sigcomm.org/sigcomm/2024/cf-artifacts/).
- [05/2024] WiseCam (journal version) accepted to IEEE Transactions on Mobile Computing.
- [05/2024] AddrMiner (journal version) accepted to [IEEE/ACM Transactions on Networking](https://ieeexplore.ieee.org/xpl/tocresult.jsp?isnumber=10720541&punumber=90). Congrats to Guanglei!
...
- [08/2022] One-way delay measurement accepted to [GLOBECOM'22](https://globecom2022.ieee-globecom.org/). Congrats to Yaozhong!
- [08/2022] ClockConverger accepted to [GLOBECOM'22](https://globecom2022.ieee-globecom.org/). Congrats to Yaozhong!
- [07/2022] iVantage accepted to [NDSS'23](https://www.ndss-symposium.org/ndss2023/). Congrats to Long!
- [06/2022] AutoIoT accepted to [IEEE Transactions on Mobile Computing](https://ieeexplore.ieee.org/document/9795895). Congrats to Linna!
- [04/2022] AddrMiner accepted to [USENIX ATC'22](https://www.usenix.org/conference/atc22). Congrats to Guanglei!
- [04/2022] Firebolt accepted to [USENIX ATC'22](https://www.usenix.org/conference/atc22). Congrats to Jiamin!
- [01/2022] DET (journal version) accepted to [IEEE/ACM Transactions on Networking](https://ieeexplore.ieee.org/xpl/tocresult.jsp?isnumber=9859542&punumber=90). Congrats to Guanglei!
...
<ul>
  <li>[12/2021] TurboNet (journal version) accepted to  <a href="https://ieeexplore.ieee.org/xpl/tocresult.jsp?isnumber=9797041&pageNumber=2">IEEE/ACM Transactions on Networking</a>. Congrats to Jiamin!</li>
  <li>[12/2021] ATE6 accepted to <a href="https://ieeexplore.ieee.org/xpl/tocresult.jsp?isnumber=9785736">IEEE Network</a>.</li>
  <li>[12/2021] CoFilter accepted to <a href="https://www.computer.org/csdl/journal/td/2022/09">IEEE Transactions on Parallel and Distributed Systems</a>. Congrats to Jiamin!</li>
  ...
  <li>[11/2018] PAVI accepted to <a href="https://infocom2019.ieee-infocom.org/">INFOCOM'19</a>.</li>
  <li>[11/2017] GAGMS accepted to <a href="https://link.springer.com/journal/11432/volumes-and-issues/61-9">Science China Information Sciences</a>.</li>
  <li>[10/2015] NIDTGA accepted to <a href="https://link.springer.com/journal/11432/volumes-and-issues/58-12">Science China Information Sciences</a>.</li>
</ul>
</details>
